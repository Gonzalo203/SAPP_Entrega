...
public class ErrorHandlingUtils {
    ...
    public String handleAuthenticationException(AuthenticationException e, String user, String targetPage,
                                                Model model, Locale locale) {
        logger.error(e.getMessage()  + " User: " + user + " tried to access.", e);
        model.addAttribute(Constants.ERROR_MESSAGE, e.getMessage());
        model.addAttribute(Constants.EXCEPTION, e);
        return targetPage;
    }
    ...
    public String handleInputValidationException (Exception e, Model model, Locale locale) {
        logger.error(e.getMessage(), e);
        model.addAttribute(Constants.ERROR_MESSAGE, e.getMessage());
        model.addAttribute(Constants.EXCEPTION, e);
    ...
    public String handlePasswordStrengthException(PasswordStrengthException e, Model model, Locale locale) {
        logger.error(e.getMessage(), e);
        model.addAttribute(Constants.ERROR_MESSAGE, e.getMessage());
        model.addAttribute(Constants.EXCEPTION, e);
        return Constants.USER_PROFILE_PAGE;
    }
    public String handleUpdatePasswordStrengthException(PasswordStrengthException e, Model model, Locale locale) {
        logger.error(e.getMessage(), e);
        model.addAttribute(Constants.ERROR_MESSAGE, e.getMessage());
        model.addAttribute(Constants.EXCEPTION, e);
        return Constants.CHANGE_PASSWORD_ENDPOINT;
    }
}
