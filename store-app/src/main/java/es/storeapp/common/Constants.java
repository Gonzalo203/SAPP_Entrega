...
public class Constants {
    ...
    /* ACB */
    public static final String INVALID_FILE_TYPE = "invalid.file.validation";
    public static final String AUTH_INVALID_PARAMS_MESSAGE = "auth.invalid.params";
    public static final String POOR_PASSWORD_STRENGTH = "poor.password.strength";
