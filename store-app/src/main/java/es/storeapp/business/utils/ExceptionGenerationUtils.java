...
public class ExceptionGenerationUtils {
    ...
    public InputValidationException toInputValidationException (String messageKey) throws InputValidationException {
        Locale locale = LocaleContextHolder.getLocale();
        String message = messageSource.getMessage(messageKey, new Object[0], locale);
        return new InputValidationException(message);
    }

    public PasswordStrengthException toPasswordStrengthException(String messageKey) throws PasswordStrengthException {
        Locale locale = LocaleContextHolder.getLocale();
        String message = messageSource.getMessage(messageKey, new Object[0], locale);
        return new PasswordStrengthException(message);
    }
}
